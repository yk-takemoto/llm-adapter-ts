...
const requireEnvVars = ["AMAZON_BEDROCK_API_MODEL_CHAT", "AWS_REGION"];
...
describe("Amazon Bedrock API 統合テスト", function () {
  this.timeout(30000);
  ...
  describe("chatCompletions インテグレーションテスト", () => {
    it("通常のテキスト会話が正しく処理されること", async function () {
      ...
      const amazonBedrockAdapter = amazonBedrockAdapterBuilder.build();
