...
exports.groqAdapterBuilder = void 0;
...
const groqClientBuilderArgsSchema = zod_1.z
    .object({
    apiKey: zod_1.z.string().min(1, "GROQ_API_KEY is required"),
})
    .passthrough();
const groqClientBuilder = {
    build: ({ args = {
        ...
        return new groq_sdk_1.Groq(parsedArgs);
    },
};
exports.groqAdapterBuilder = {
    build: ({ buildClientInputParams } = {}) => ({
        ...
        speechToText: async ({ args, argsSchema = llm_adapter_schemas_1.speechToTextArgsSchema, config = {
            ...
            apiModelAudioTranscription: zod_1.z.string().min(1, "GROQ_API_MODEL_AUDIO_TRANSCRIPTION is required"),
        }), } = {}) => {
        ...
        textToSpeech: async ({ args, argsSchema = llm_adapter_schemas_1.textToSpeechArgsSchema, config = {
            ...
            apiModelText2Speech: zod_1.z.string().min(1, "GROQ_API_MODEL_TEXT2SPEECH is required"),
        }), } = {}) => {
