...
exports.embeddingOptionsSchema = zod_1.z
    .object({
    dimensions: zod_1.z.number().optional(),
})
    .catchall(zod_1.z.any());
exports.embeddingArgsSchema = zod_1.z.object({
    text: zod_1.z.string(),
    options: exports.embeddingOptionsSchema.optional(),
});
exports.embeddingResultSchema = zod_1.z.object({
    embedding: zod_1.z.array(zod_1.z.number()),
});
exports.llmIdSchema = zod_1.z.enum(["OpenAI", "AzureOpenAI", "Anthropic", "Google", "Groq", "AmazonBedrock"]);
