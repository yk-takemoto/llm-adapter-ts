...
exports.llmIdSchema = exports.textToSpeechResultSchema = exports.textToSpeechArgumentsSchema = exports.textToSpeechOptionsSchema = exports.speechToTextResultSchema = exports.speechToTextArgumentsSchema = exports.speechToTextOptionsSchema = exports.chatCompletionsResultSchema = exports.chatCompletionsArgumentsSchema = exports.chatCompletionsOptionsSchema = exports.chatCompletionsContentSchema = exports.GeneralConfigSchema = exports.GeneralResultSchema = exports.GeneralArgumentsSchema = exports.mcpToolSchema = void 0;
...
exports.chatCompletionsArgumentsSchema = zod_1.z.object({
...
exports.speechToTextOptionsSchema = zod_1.z
    ...
    .catchall(zod_1.z.any());
exports.speechToTextArgumentsSchema = zod_1.z.object({
...
exports.textToSpeechOptionsSchema = zod_1.z
    ...
    .catchall(zod_1.z.any());
exports.textToSpeechArgumentsSchema = zod_1.z.object({
